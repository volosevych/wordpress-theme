        ...
        <div className='flex justify-between max-lg:flex-col-reverse'>
            <div>
                ...
                <div className='flex flex-row space-x-4 pb-5'>
                    {/* Facebook */}
                    <a href="https://example.com"><span className='border border-white bg-white rounded-full p-2 flex items-center justify-center w-8 h-8 text-red font-bold hover:bg-red hover:text-white transition-colors duration-500' >f</span></a>
                    {/* Twitter */}
